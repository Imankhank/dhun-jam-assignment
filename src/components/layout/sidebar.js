  ...
  const sidebarData = [
    {
      ...
      image: (
        <DashboardIcon
          fill={activeTab === "Dashboard" ? "#fff" : "#000"}
          width={20}
          height={20}
        />
      ),
    },
    {
      ...
      image: (
        <AccountIcon
          fill={activeTab === "Accounts" ? "#fff" : "#000"}
          width={20}
          height={20}
        />
      ),
...

    {
      ...
      image: (
        <DollarIcon
          fill={activeTab === "Payroll" ? "#fff" : "#000"}
          width={20}
          height={20}
        />
      ),
    },
    {
      ...
      image: (
        <ReportIcon
          fill={activeTab === "Reports" ? "#fff" : "#000"}
          width={20}
          height={20}
        />
      ),
    },
    {
      ...
      image: (
        <AdvisorIcon
          fill={activeTab === "Advisor" ? "#fff" : "#000"}
          width={20}
          height={20}
        />
      ),
    },
    {
      ...
      image: (
        <ContactIcon
          fill={activeTab === "Contacts" ? "#fff" : "#000"}
          width={20}
          height={20}
        />
      ),
    ...
    <div className="sidebar">
      <div className="pt-lg-5 pt-2">
        {sidebarData.map((item) => (
          ...
          >
            <div
              className={`ps-5 py-3 d-flex align-items-center ${
                activeTab === item?.name ? "color-fff" : "color-000"
              } `}
            >
              {item?.image}
              <span className="ms-3 fw_500">{item?.name}</span>
            </div>
          </div>
        ))}
      </div>
